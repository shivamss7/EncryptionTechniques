 ...
 */
function generateKey(_x, _x2, _x3) {
...
function _sign() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(msg, privateJwk, hash, algorithm, webCrypto) {
    var algo, signature, key, _key;
...
function verify(_x9, _x10, _x11, _x12, _x13, _x14) {
...
function _verify() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee3(msg, signature, publicJwk, hash, algorithm, webCrypto) {
    var algo, valid, key, _key2;
...
function encrypt(_x15, _x16, _x17, _x18, _x19) {
...
function _encrypt() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee4(msg, publicJwk, hash, label, webCrypto) {
    var algo, encrypted, key, _key3;
...
function decrypt(_x20, _x21, _x22, _x23, _x24) {
...
function _decrypt() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee5(msg, privateJwk, hash, label, webCrypto) {
    var algo, decrypted, key, _key4;
